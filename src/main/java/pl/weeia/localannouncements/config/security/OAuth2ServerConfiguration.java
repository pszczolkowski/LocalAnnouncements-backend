...
import pl.weeia.localannouncements.security.AjaxLogoutSuccessHandler;
import pl.weeia.localannouncements.security.AuthoritiesConstants;
import pl.weeia.localannouncements.security.Http401UnauthorizedEntryPoint;
   ...
   protected static class ResourceServerConfiguration
      ...
      public void configure(HttpSecurity http)
         ...
         .and()                
            ...
            .antMatchers("/account/password/remind").permitAll()
            .antMatchers("/account/password_reminder/activate").permitAll()
